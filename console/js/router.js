...
const TITLES={dashboard:['Dashboard','Fleet overview'],devices:['Devices','Provisioned devices and their update state'],device:['Device','Device detail'],packages:['Packages','Your packages and the feeds you subscribe to'],package:['Package','Package detail'],remote:['Remote Access','Your SSH key, tunnel duration, and active sessions'],system:['System','Services, resources, and live logs on the server']};
